...
* Desafio diário de programação focado no domínio da linguagem Python (Curso da Angela Yu).
* Desenvolvimento de portfólio contínuo com múltiplos projetos práticos e lógica de programação avançada.
* **Tópicos:** Orientação a Objetos (OOP), Estruturas de Dados, Automação de Arquivos, tratamento de erros e desenvolvimento de jogos 2D.
* **Status:** 🚀 Em andamento (Códigos e exercícios atualizados diariamente no repositório).
...
* **LinkedIn:** [Leon Vinicius](https://www.linkedin.com/in/leon-vinicius/)
